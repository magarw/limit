...
curl https://dl.fbaipublicfiles.com/flores101/dataset/flores101_dataset.tar.gz --output flores101_dataset.tar.gz
curl https://dl.fbaipublicfiles.com/flores101/dataset/flores_wmt22_supplement.tar.gz --output flores_wmt22_supplement.tar.gz
